...
export default async function LusinPage() {
    ...
    const grouped =
        menuData?.menu?.categories && menuData?.menu?.products ? groupByCategory(menuData.menu.categories, menuData.menu.products) : [];
            ...
            <div className="relative min-h-screen overflow-hidden">
                <div className="absolute inset-0">
                    ...
                    <div
                        ...
                        style={{ background: "linear-gradient(to bottom, rgba(0,0,0,.8), rgba(0,0,0,.3))" }}
                    />
                </div>
            ...
            <div id="about" className="max-w-5xl mx-auto px-4 py-20">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4 text-gray-700">
                        <p>
                            Lusin is Armenian cuisine. Lusin comes expressing "the moon" - a beautiful and delicate symbol in the Armenian
                            culture.
                        </p>
                        <p>
                            Lusin is a leading brand in the Kingdom of Saudi Arabia and the United Kingdom to serve Armenian foods with a
                            modern twist.
                        </p>
                        <p>
                            Lusin serves its guests enticing Armenian specialties renowned for their distinctive aromas and flavorful
                            preparations.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <div className="space-y-2 text-sm">
                                <a
                                    href="tel:+966115200161"
                                    className="flex items-center gap-2 text-gray-600 hover:text-[#d10f8b] transition-colors"
                                >
                                    <span>+966 11 520 0161</span>
                                </a>
                                <a
                                    href="mailto:lusinrestaurant@mira-foods.com"
                                    className="flex items-center gap-2 text-gray-600 hover:text-[#d10f8b] transition-colors"
                                >
