...
<template>
    <div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 bg-white">
            <div>
                <img src="https://1food-menu-demos-2.b-cdn.net/gud/gud-grid-3.png" alt=" " class="w-full object-cover" />
            </div>
            ...
            <div>
                <img src="https://1food-menu-demos-2.b-cdn.net/gud/gud-grid-2.png" alt=" " class="w-full object-cover" />
            </div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-3 bg-white">
            <div class="flex px-6 min-h-[320px]">
            ...
            <div>
                <img src="https://1food-menu-demos-2.b-cdn.net/gud/gud-grid-1.png" alt=" " class="w-full object-cover" />
            </div>
            <div class="flex px-6 min-h-[320px]">
                <div class="m-auto flex items-center justify-center flex-col gap-4 text-2xl">
