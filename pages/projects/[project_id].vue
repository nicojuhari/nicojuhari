...
useHead({
    title: story?.value.content.title + ' | Restaurant Website Developer & Freelancer',
    meta: [
        { name: 'keywords', content: story?.value.content.title + ' restaurant website developer, freelancer, business websites, website development' },
        { name: 'description', content: `Project - ${story?.value.content.title} | Restaurant Website Developer & Freelancer` },
    ],
})
