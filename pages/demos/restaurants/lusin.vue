...
<template>
    ...
    <div class="font-sans">
        <!-- Menu -->
        <div id="menu" class="container my-24">
        ...
        <div class="container my-24 text-center">
          ...
          <div class="flex justify-center gap-6">
            <!-- Instagram -->
            <a href="#" class="group">
              <div class="w-12 h-12 bg-white rounded-lg flex items-center justify-center hover:bg-gray-100 transition-colors">
                <UIcon name="i-ph-instagram-logo" class="w-6 h-6 text-gray-800" />
              </div>
            </a>
            ...
            <a href="#" class="group">
              <div class="w-12 h-12 bg-white rounded-lg flex items-center justify-center hover:bg-gray-100 transition-colors">
                <UIcon name="i-ph-facebook-logo" class="w-6 h-6 text-gray-800" />
              </div>
    ...
    <div class="py-24 bg-gray-100/50">
