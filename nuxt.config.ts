...
export default defineNuxtConfig({
    ...
    app: {
        head: { 
            ...
            title: 'Web Developer & Freelancer | I create Restaurant Websites',
            link: [
            ...
            meta: [
                { name: 'description', content: 'Web Developer & Freelancer Vienna Austria - I create websites for restaurants, bars and cafes' },
