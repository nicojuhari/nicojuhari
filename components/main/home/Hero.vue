...
<template>
    <div class="container">
        ...
        <div class="text-center py-16">
            <p class="text-lg text-gray-600 mb-4">👋 Hello, I am Nick</p>
            <div class="flex justify-center mb-6">
                <img src="/assets/nick-profile-photo.webp" class="w-24 h-24 rounded-full object-cover border-4 shrink-0 border-gray-200" alt="nick profile photo" />
            </div>
            ...
            <div class="inline-flex items-center gap-4 justify-center border border-gray-200/60 rounded-lg px-6 p-4">
