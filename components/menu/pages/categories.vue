                    ...
                    <tbody data-sortable class="divide-y divide-gray-100" ref="tableBody">
                        <tr v-for="(item, idx ) in filteredCategories" :key="item.uid" class="bg-white">
                            ...
                            <td class="px-4 py-2 flex items-center justify-end gap-4">
                                <UButton @click="() => viewCategory(item.uid)" square variant="soft" icon="i-ph-pencil-simple-light" color="gray"></UButton>
                                <UButton @click="() => preDeleteCategory(item.uid)" square color="red" variant="soft" icon="i-ph-trash-light"></UButton>
                            </td>
                        </tr>
                    </tbody>
                </table>
